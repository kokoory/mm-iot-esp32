...
#define MAV_MISSION_TYPE_FENCE    1
#define MAV_MISSION_TYPE_RALLY    2
#define MAV_MISSION_TYPE_ALL      255

/* ESTIMATOR_STATUS_FLAGS */
#define ESTIMATOR_ATTITUDE        (1 << 0)
#define ESTIMATOR_VELOCITY_HORIZ  (1 << 1)
#define ESTIMATOR_VELOCITY_VERT   (1 << 2)
#define ESTIMATOR_POS_HORIZ_REL   (1 << 3)
#define ESTIMATOR_POS_HORIZ_ABS   (1 << 4)
#define ESTIMATOR_POS_VERT_ABS    (1 << 5)
#define ESTIMATOR_POS_VERT_AGL    (1 << 6)
#define ESTIMATOR_PRED_POS_HORIZ_REL (1 << 10)
#define ESTIMATOR_PRED_POS_HORIZ_ABS (1 << 11)
#define ESTIMATOR_GPS_GLITCH      (1 << 15)

/* MAV_PROTOCOL_CAPABILITY - additional */
#define MAV_PROTOCOL_CAPABILITY_MISSION_FLOAT       (1ULL << 0)
#define MAV_PROTOCOL_CAPABILITY_COMMAND_INT          (1ULL << 5)
#define MAV_PROTOCOL_CAPABILITY_FTP                  (1ULL << 7)
#define MAV_PROTOCOL_CAPABILITY_MISSION_FENCE        (1ULL << 12)
#define MAV_PROTOCOL_CAPABILITY_MISSION_RALLY        (1ULL << 13)
#define MAV_PROTOCOL_CAPABILITY_FLIGHT_TERMINATION   (1ULL << 10)
